...
// precisionService.ts; this exposes Claude as an LlmCall transport
// (SSE streaming + prompt-cached system prompt, handled inside callClaude).
// ═════════════════════════════════════════════════════════════════════════════

export const claudeLlm = (apiKey: string): LlmCall =>
  (system, user, temperature, maxTokens) =>
    callClaude(apiKey, system, user, temperature, maxTokens);
